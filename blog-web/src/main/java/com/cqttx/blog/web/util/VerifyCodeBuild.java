...
public class VerifyCodeBuild {
	...
	private char[] codeSequence = { 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'J', 'K', 'M', 'N', 'P', 'Q', 'R', 'S', 'T',
			'U', 'V', 'W', 'X', 'Y', '3', '4', '5', '6', '7', '8', '9' };

	// 生成随机数
	private Random random = new Random();

	public VerifyCodeBuild() {
		this.createCode();
	}
	 ...
	 * 
	 */
	public VerifyCodeBuild(int width, int height) {
		this.width = width;
		this.height = height;
		this.createCode();
	}
	 ...
	 *            干扰线条数
	 */
	public VerifyCodeBuild(int width, int height, int codeCount, int lineCount) {
		this.width = width;
		this.height = height;
	...
	class ImgFontByte {
		...
		private String getFontByteStr() {
			return "0001000000100040000400c04f532f327d8175d4000087740000005650434c5461e3d9fb000087cc00000036636d61709cbc69ab00007a640";
		}
